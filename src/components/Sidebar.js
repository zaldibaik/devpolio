...
const Sidebar = () => {
  return (
    <div className="ml-10 mt-32 mb-32 fixed h-full min-h-screen w-50 flex flex-col bg-customBlue2 text-white shadow-lg mx-auto p:10">
